...
const STRINGS = {
  en: {
    ...
    "menu.newOffline": "New offline game",
    "menu.newOfflineSub": "Two players, one device",
    "menu.newOnline": "New online game",
    "menu.newOnlineSub": "Play at your own pace",
    "menu.continue": "Continue",
    "menu.continueSub": "{n} in progress",
    "menu.continueEmpty": "No games yet",
    "menu.friends": "Friends",
    "menu.friendsSub": "{n} saved",
    "menu.friendsEmpty": "Nobody yet",
    "select.title": "Choose a game",
    "select.titleOffline": "Offline - choose a game",
    "select.titleOnline": "Online - choose a game",
    "select.inviteTitle": "Choose a game for {name}",
    "friends.hint": "Anyone you have played is saved here. Inviting a friend sends the game straight to them - no link needed.",
    "btn.menu": "Menu",
    "btn.shareGame": "Share",
    "share.scanHint": "Let your opponent scan this, or send them the link.",

    "friends.addButton": "Add Friend",
    "addFriend.yourLinkHint": "Share this so a friend can add you. Or paste their link below.",
    "addFriend.pasteLabel": "Or paste their link",
    "addFriend.pastePlaceholder": "Paste a friend link or ID",
    "addFriend.addBtn": "Add",
    "addFriend.invalid": "That isn't a valid friend link.",
    "addFriend.self": "That's your own link.",
  ...
  de: {
    ...
    "menu.newOffline": "Neues Offline-Spiel",
    "menu.newOfflineSub": "Zwei Spieler, ein Gerät",
    "menu.newOnline": "Neues Online-Spiel",
    "menu.newOnlineSub": "Spiel in deinem Tempo",
    "menu.continue": "Fortsetzen",
    "menu.continueSub": "{n} laufend",
    "menu.continueEmpty": "Noch keine Spiele",
    "menu.friends": "Freunde",
    "menu.friendsSub": "{n} gespeichert",
    "menu.friendsEmpty": "Noch niemand",
    "select.title": "Spiel wählen",
    "select.titleOffline": "Offline - Spiel wählen",
    "select.titleOnline": "Online - Spiel wählen",
    "select.inviteTitle": "Spiel für {name} wählen",
    "friends.hint": "Alle, gegen die du gespielt hast, werden hier gespeichert. Eine Einladung geht direkt an sie - ganz ohne Link.",
    "btn.menu": "Menü",
    "btn.shareGame": "Teilen",
    "share.scanHint": "Lass deinen Gegner das scannen oder schick ihm den Link.",

    "friends.addButton": "Freund hinzufügen",
    "addFriend.yourLinkHint": "Teile das, damit dich ein Freund hinzufügen kann. Oder füge unten seinen Link ein.",
    "addFriend.pasteLabel": "Oder Link einfügen",
    "addFriend.pastePlaceholder": "Freundeslink oder ID einfügen",
    "addFriend.addBtn": "Hinzufügen",
    "addFriend.invalid": "Das ist kein gültiger Freundeslink.",
    "addFriend.self": "Das ist dein eigener Link.",
  ...
  tr: {
    ...
    "menu.newOffline": "Yeni çevrimdışı oyun",
    "menu.newOfflineSub": "İki oyuncu, tek cihaz",
    "menu.newOnline": "Yeni çevrimiçi oyun",
    "menu.newOnlineSub": "Kendi hızında oyna",
    "menu.continue": "Devam et",
    "menu.continueSub": "{n} devam ediyor",
    "menu.continueEmpty": "Henüz oyun yok",
    "menu.friends": "Arkadaşlar",
    "menu.friendsSub": "{n} kayıtlı",
    "menu.friendsEmpty": "Henüz kimse yok",
    "select.title": "Bir oyun seç",
    "select.titleOffline": "Çevrimdışı - bir oyun seç",
    "select.titleOnline": "Çevrimiçi - bir oyun seç",
    "select.inviteTitle": "{name} için bir oyun seç",
    "friends.hint": "Oynadığın herkes burada saklanır. Bir arkadaşı davet ettiğinde oyun doğrudan ona gider - bağlantı gerekmez.",
    "btn.menu": "Menü",
    "btn.shareGame": "Paylaş",
    "share.scanHint": "Rakibin bunu tarasın ya da bağlantıyı gönder.",

    "friends.addButton": "Arkadaş Ekle",
    "addFriend.yourLinkHint": "Bir arkadaş seni eklesin diye bunu paylaş. Ya da aşağıya onun bağlantısını yapıştır.",
    "addFriend.pasteLabel": "Ya da bağlantısını yapıştır",
    "addFriend.pastePlaceholder": "Arkadaş bağlantısı veya kimlik yapıştır",
    "addFriend.addBtn": "Ekle",
    "addFriend.invalid": "Bu geçerli bir arkadaş bağlantısı değil.",
  ...
  rom: {
    ...
    "menu.newOffline": "Neon peğnid horis internet",
    "menu.newOfflineSub": "Dio peğnideri, ena cihaz",
    "menu.newOnline": "Neon peğnid onlayn",
    "menu.newOnlineSub": "Peks me tin isihian su",
    "menu.continue": "Sinehison",
    "menu.continueSub": "{n} pane akoma",
    "menu.continueEmpty": "Çi eği akoma peğnidia",
    "menu.friends": "Fili",
    "menu.friendsSub": "{n} filadelfi",
    "menu.friendsEmpty": "Kanenan akoma",
    "select.title": "Diale ena peğnid",
    "select.titleOffline": "Horis internet - diale ena peğnid",
    "select.titleOnline": "Onlayn - diale ena peğnid",
    "select.inviteTitle": "Diale ena peğnid ğia ton {name}",
    "friends.hint": "Opios epaiksen mese, menni athe. Atan kalis ena filon, to peğnid pai kat efthian ase aton - çi hriazete linki.",
    "btn.menu": "Meni",
    "btn.shareGame": "Miraz",
    "share.scanHint": "As sarosi ato o andipalos, i steilon ato to linki.",

    "friends.addButton": "Vale filon",
    "addFriend.yourLinkHint": "Miras atto na se vali ena filos. I vale to linki atu ke pos.",
    "addFriend.pasteLabel": "I vale to linki atu",
    "addFriend.pastePlaceholder": "Vale to linki i tin taftotita tu filu",
    "addFriend.addBtn": "Vale",
    "addFriend.invalid": "Atto çi en kalon linki filias.",
    "addFriend.self": "Atto en to diko su linki.",
  ...
  it: {
    ...
    "menu.newOffline": "Nuova partita offline",
    "menu.newOfflineSub": "Due giocatori, un dispositivo",
    "menu.newOnline": "Nuova partita online",
    "menu.newOnlineSub": "Gioca con i tuoi tempi",
    "menu.continue": "Continua",
    "menu.continueSub": "{n} in corso",
    "menu.continueEmpty": "Ancora nessuna partita",
    "menu.friends": "Amici",
    "menu.friendsSub": "{n} salvati",
    "menu.friendsEmpty": "Ancora nessuno",
    "select.title": "Scegli un gioco",
    "select.titleOffline": "Offline - scegli un gioco",
    "select.titleOnline": "Online - scegli un gioco",
    "select.inviteTitle": "Scegli un gioco per {name}",
    "friends.hint": "Chiunque abbia giocato con te viene salvato qui. Invitando un amico la partita arriva direttamente a lui - senza link.",
    "btn.menu": "Menù",
    "btn.shareGame": "Condividi",
    "share.scanHint": "Fai scansionare questo al tuo avversario, oppure mandagli il link.",

    "friends.addButton": "Aggiungi amico",
    "addFriend.yourLinkHint": "Condividi questo perché un amico ti possa aggiungere. Oppure incolla il suo link qui sotto.",
    "addFriend.pasteLabel": "Oppure incolla il suo link",
    "addFriend.pastePlaceholder": "Incolla un link amico o un ID",
    "addFriend.addBtn": "Aggiungi",
    "addFriend.invalid": "Non è un link amico valido.",
    "addFriend.self": "Questo è il tuo link.",
  ...
  zh: {
    ...
    "menu.newOffline": "新的离线对局",
    "menu.newOfflineSub": "两人共用一台设备",
    "menu.newOnline": "新的在线对局",
    "menu.newOnlineSub": "按自己的节奏下棋",
    "menu.continue": "继续对局",
    "menu.continueSub": "{n} 局进行中",
    "menu.continueEmpty": "还没有对局",
    "menu.friends": "好友",
    "menu.friendsSub": "已保存 {n} 人",
    "menu.friendsEmpty": "还没有好友",
    "select.title": "选择游戏",
    "select.titleOffline": "离线 - 选择游戏",
    "select.titleOnline": "在线 - 选择游戏",
    "select.inviteTitle": "为 {name} 选择游戏",
    "friends.hint": "与你对局过的人都会保存在这里。邀请好友时对局会直接送达 - 无需链接。",
    "btn.menu": "菜单",
    "btn.shareGame": "分享",
    "share.scanHint": "让对手扫描，或把链接发给他。",

    "friends.addButton": "添加好友",
    "addFriend.yourLinkHint": "分享这个，让好友添加你。或在下方粘贴对方的链接。",
    "addFriend.pasteLabel": "或粘贴对方的链接",
    "addFriend.pastePlaceholder": "粘贴好友链接或 ID",
    "addFriend.addBtn": "添加",
    "addFriend.invalid": "这不是有效的好友链接。",
